...
class model_telegram_instance {
  ...
  model_telegram_instance({
    ...
    this.link = '',
    this.enable = false,
    this.send_support = false, // Default value
  }) {
    controllers = {
      ...
      'send_support': ValueNotifier<bool>(send_support), // Add send_support controller
    };
  }
  ...
  dynamic getValueByKey(String key) => switch (key) {
        ...
        'name' => name,
        'enable' => enable,
        'send_support' => send_support, // Add to key retrieval
        _ => null,
      };
  ...
  factory model_telegram_instance.toModel(Map<String, dynamic> json) {
    return modelType(
      ...
      send_support: json['send_support'] as bool, // Add send_support to model conversion
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'name': name,
      'enable': enable,
      'send_support': send_support, // Add send_support to JSON
    };
  }
  ...
  modelType get_model() {
    return modelType(
      ...
      send_support: (controllers['send_support'] as ValueNotifier<bool>).value, // Add send_support retrieval
    );
  }
  ...
  void controller_clear() {
    ...
    controllers['send_support']?.value = false; // Add send_support clearing
  }
