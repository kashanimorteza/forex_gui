//--------------------------------------------------------------------------------- location
// lib/models/model_way.dart

//--------------------------------------------------------------------------------- Description
// This is model for way
...
//--------------------------------------------------------------------------------- Global
typedef modelType = model_way;
String api_route = models_api.way;
...
class model_way {
  ...
  //--------------------------------[toModel]
  factory model_way.toModel(Map<String, dynamic> json) {
    return modelType(
      id: json['id'] as int,
