//--------------------------------------------------------------------------------- location
// lib/models/model_network.dart

//--------------------------------------------------------------------------------- Description
// This is model for network
...
//--------------------------------------------------------------------------------- Global
typedef modelType = model_network;
String api_route = models_api.network;
...
class model_network {
  ...
  //--------------------------------[toModel]
  factory model_network.toModel(Map<String, dynamic> json) {
    return modelType(
      id: json['id'] as int,
