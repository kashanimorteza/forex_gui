//--------------------------------------------------------------------------------- location
// lib/models/model_service.dart

//--------------------------------------------------------------------------------- Description
// This is model for service
...
//--------------------------------------------------------------------------------- Global
typedef modelType = model_service;
String api_route = models_api.service;
...
class model_service {
  ...
  //--------------------------------[toModel]
  factory model_service.toModel(Map<String, dynamic> json) {
    return modelType(
      id: json['id'] as int,
