//--------------------------------------------------------------------------------- location
// lib/models/model_profit_manager.dart

//--------------------------------------------------------------------------------- Description
// This is model for profit_manager
...
//--------------------------------------------------------------------------------- Global
typedef modelType = model_profit_manager;
String api_route = models_api.profit_manager;

//--------------------------------------------------------------------------------- Model
class model_profit_manager {
  //--------------------------------[Field]
  int id;
  String name;
  String? description;
  ...
  //--------------------------------[toModel]
  factory model_profit_manager.toModel(Map<String, dynamic> json) {
    return modelType(
      id: json['id'] as int,
