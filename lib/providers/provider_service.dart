//--------------------------------------------------------------------------------- location
// lib/providers/provider_service.dart

//--------------------------------------------------------------------------------- Description
// This is provider for service
...
//--------------------------------------------------------------------------------- Global
typedef modelType_base = model_service;
String title_base = models_title.service;

//--------------------------------------------------------------------------------- Provider
class provider_service with ChangeNotifier {
  //--------------------------------[Fields]
  var _context;
  var _drawer;
  var _prv;
  ...
  //--------------------------------------------------------------------------------- UI
  view() {
    var view_1 = bul_list_com<modelType_base>(context: _context, title: title_base, data_base: _data_base, fields: models_fileds.service, action: api);
