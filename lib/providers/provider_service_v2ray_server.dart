//--------------------------------------------------------------------------------- location
// lib/providers/provider_service_v2ray_server.dart

//--------------------------------------------------------------------------------- Description
// This is provider for service_v2ray_server
...
//--------------------------------------------------------------------------------- Global
typedef modelType_base = model_service_v2ray_server;
String title = models_title.service_v2ray_server;
String appbar_title = models_title.service_v2ray;

//--------------------------------------------------------------------------------- Provider
class provider_service_v2ray_server with ChangeNotifier {
  //--------------------------------[Fields]
  var _context;
  var _drawer;
  var _prv;
  ...
  view() {
    ...
    var view_1 = build_complete_2<modelType_base>(
      ...
      action: api,
      size_lable: 200,
      fields: models_fileds.service_v2ray_server,
    );
