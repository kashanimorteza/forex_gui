//--------------------------------------------------------------------------------- location
// lib/providers/provider_network.dart

//--------------------------------------------------------------------------------- Description
// This is provider for network
...
//--------------------------------------------------------------------------------- Global
typedef modelType_base = model_network;
String title_base = models_title.network;

//--------------------------------------------------------------------------------- Provider
class provider_network with ChangeNotifier {
  //--------------------------------[Fields]
  var _context;
  var _drawer;
  var _prv;
  ...
  //--------------------------------------------------------------------------------- UI
  view() {
    var view_1 = bul_list_com<modelType_base>(context: _context, title: title_base, data_base: _data_base, fields: models_fileds.network, action: api);
