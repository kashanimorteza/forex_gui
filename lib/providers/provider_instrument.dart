//--------------------------------------------------------------------------------- Location
// lib/providers/provider_instrument.dart

//--------------------------------------------------------------------------------- Description
// This is provider for instrument
...
import 'package:mkpanel_gui/models/model_instrument.dart';

//--------------------------------------------------------------------------------- Global
typedef modelType_base = model_instrument;
String title_base = models_title.instrument;
String title_appbar = models_title.base;

//--------------------------------------------------------------------------------- Provider
class provider_instrument with ChangeNotifier {
  //--------------------------------[Fields]
  var _context;
  var _drawer;
  var _prv;
  ...
  view() {
    ...
    var ui = widget_ui(
      ...
      api: api,
      fields: models_fileds.instrument,
    );
    //----------[app_bar]
