//--------------------------------------------------------------------------------- Location
// lib/providers/provider_money_management.dart

//--------------------------------------------------------------------------------- Description
// This is provider for money_management
...
//--------------------------------------------------------------------------------- Global
typedef modelType_base = model_money_management;
String title_base = models_title.money_management;
String title_appbar = models_title.base;

//--------------------------------------------------------------------------------- Provider
class provider_money_management with ChangeNotifier {
  //--------------------------------[Fields]
  var _context;
  var _drawer;
  var _prv;
  ...
  view() {
    ...
    var ui = widget_ui(
      ...
      api: api,
      fields: models_fileds.money_management,
    );
    //----------[app_bar]
