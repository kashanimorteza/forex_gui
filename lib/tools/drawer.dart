    ...
    return Drawer(
      child: ListView(
        ...
        children: <Widget>[
          ...
          ListTile(leading: Icon(Icons.person), title: Text(models_menu.money_management), onTap: () => {prv_page.page = const_model_list.money_management, Navigator.pop(context)}),
